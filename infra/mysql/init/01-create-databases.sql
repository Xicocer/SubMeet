...
CREATE DATABASE IF NOT EXISTS submeet_halls
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_unicode_ci;

CREATE DATABASE IF NOT EXISTS submeet_booking
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_unicode_ci;
...
GRANT ALL PRIVILEGES ON submeet_halls.* TO 'diploma'@'%';
GRANT ALL PRIVILEGES ON submeet_booking.* TO 'diploma'@'%';
